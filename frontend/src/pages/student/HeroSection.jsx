        ...
        <div className='relative bg-linear-to-r from-blue-500 to bg-indigo-600 dark:from-gray-800 dark:to-gray-900 py-20 px-4 text-center '>
            <div className='max-w-3xl mx-auto '>
                ...
                <form action="" className='flex items-center bg-white dark:bg-gray-800 rounded-full shadow-lg overflow-hidden max-w-xl mx-auto mb-6 '>
                    <Input type="text" placeholder="Search Courses" className="flex grow border-none focus-visible:ring-0 px-6 py-4 text-gray-900 dark:text-gray-100 placeholder-gray-400 dark:placeholder-gray-500" />
                ...
                <Button className="bg-white dark:bg-gray-800 text-blue-600 rounded-full hover:bg-gray-200 p-5">Explore Courses</Button>
            </div>
