        ...
        <div className='max-w-4xl mx-auto px-4 my-24'>
                ...
                <div>
                    <div className='mb-2'>
                        <h1 className='font-semibold text-gray-900 dark:text-shadow-gray-100'>
                            Name:
                            <span className='font-normal text-gray-700 dark:text-gray-300 ml-2'>Sushant Pal</span>
                        </h1>
                    </div>
                    <div className='mb-2'>
                        <h1 className='font-semibold text-gray-900 dark:text-shadow-gray-100'>
                            Email:
                            <span className='font-normal text-gray-700 dark:text-gray-300 ml-2'>sushantpal005@gmail.com</span>
                        </h1>
                    </div>
                    <div className='mb-2'>
                        <h1 className='font-semibold text-gray-900 dark:text-shadow-gray-100'>
            ...
            <div>
                ...
                <div className='grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4 my-5'>
                    {
                        isLoading ? ([1, 2, 3].map((_, index) => <EnrolledCourseSkeleton key={index} />)) : (enrolledCourses.length === 0 ? <h1>You haven't enrolled yet</h1> : (
